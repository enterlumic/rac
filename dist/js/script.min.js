...
const App=(()=>{"use strict";function e(e,t){const n=[window.innerWidth];return window.addEventListener("resize",()=>{const o=n.length;n.push(window.innerWidth),n[o]!==n[o-1]&&(clearTimeout(t),t=setTimeout(e,150))}),e}function t(e){let t,n,o;switch(e){case"xs":o="d-none d-sm-block";break;case"sm":o="d-block d-sm-none d-md-block";break;case"md":o="d-block d-md-none d-lg-block";break;case"lg":o="d-block d-lg-none d-xl-block";break;case"xl":o="d-block d-xl-none";break;case"smDown":o="d-none d-md-block";break;case"mdDown":o="d-none d-lg-block";break;case"lgDown":o="d-none d-xl-block";break;case"smUp":o="d-block d-sm-none";break;case"mdUp":o="d-block d-md-none";break;case"lgUp":o="d-block d-lg-none"}return(t=document.createElement("div")).setAttribute("class",o),document.body.appendChild(t),n=null===t.offsetParent,t.parentNode.removeChild(t),n}function n(){return t("xs")}function o(){return t("sm")}function l(){return t("md")}function c(){return t("lg")}function s(){return t("xl")}function r(){return t("lgUp")}return{init:()=>{!function(){for(const e of document.querySelectorAll('.custom-file > input[type="file"]'))e.addEventListener("change",()=>{const t=e.files.length;let n=t?e.files[0].name:"Choose file";n=t>1?t+" files":n,e.parentElement.querySelector("label").textContent=n})}(),function(){for(const e of document.querySelectorAll(".dropdown-hover"))e.addEventListener("mouseenter",()=>{r()&&e.classList.add("show")}),e.addEventListener("mouseleave",()=>{r()&&e.classList.remove("show")})}(),function(){for(const e of document.querySelectorAll("[data-cover]"))e.style.backgroundImage=`url(${e.getAttribute("data-cover")})`}(),function(){for(const e of document.querySelectorAll(".custom-spinner")){const t=e.querySelector('input[type="number"]'),n=t.getAttribute("min"),o=t.getAttribute("max"),l=e.querySelector(".up"),c=e.querySelector(".down");l.addEventListener("click",()=>{t.value<o&&(t.value=parseInt(t.value)+1,t.dispatchEvent(new Event("change")))}),c.addEventListener("click",()=>{t.value>n&&(t.value=parseInt(t.value)-1,t.dispatchEvent(new Event("change")))})}}(),function(){if(document.querySelector("header")){const e=document.querySelector("header");e.insertAdjacentHTML("beforebegin",'<div id="tmpWrapper"></div>');const t=document.getElementById("tmpWrapper"),n=t.offsetTop,o="fixed-top";let l=window.pageYOffset;window.addEventListener("scroll",()=>{const c=e.offsetHeight;let s=window.pageYOffset;s<l&&s<=n?(e.classList.contains(o)&&e.classList.remove(o),t.style.height=0):s>=n+c+20&&(t.style.height=c+"px",e.classList.add(o)),l=s})}}(),function(){for(const e of document.querySelectorAll(".forwardable"))e.addEventListener("click",()=>{$(e).dropdown("toggle"),location.href=e.href})}(),e(()=>{!function(){for(const e of document.querySelectorAll("[data-height]")){const t=e.getAttribute("data-height").split(" ");t.length>1?(n()&&(e.style.height=t[0]),o()&&(e.style.height=t[1]),l()&&(e.style.height=t[2]),c()&&(e.style.height=t[3]),s()&&(e.style.height=t[4])):e.style.height=t[0]}}(),function(){for(const e of document.querySelectorAll("[data-width]")){const t=e.getAttribute("data-width").split(" ");t.length>1?(n()&&(e.style.width=t[0]),o()&&(e.style.width=t[1]),l()&&(e.style.width=t[2]),c()&&(e.style.width=t[3]),s()&&(e.style.width=t[4])):e.style.width=t[0]}}()})(),function(){for(const e of document.querySelectorAll('[data-toggle="buttons"]'))if("radio"===e.querySelector("input").type)for(const t of e.querySelectorAll(".btn"))t.addEventListener("click",()=>{t.classList.contains("disabled")&&setTimeout(()=>{t.parentNode.querySelector("input:checked").parentNode.classList.toggle("active")},10)})}()},resize:t=>e(t),xs:()=>n(),sm:()=>o(),md:()=>l(),lg:()=>c(),xl:()=>s(),smDown:()=>t("smDown"),mdDown:()=>t("mdDown"),lgDown:()=>t("lgDown"),smUp:()=>t("smUp"),mdUp:()=>t("mdUp"),lgUp:()=>r()}})();